...
const UserCars = ({ navigation }) => {
  ...
  return (
    <View>
        <Text style={{fontSize: 30, fontWeight: "bold", marginBottom: 20,marginTop:80}}>Your Cars</Text>
        {
            cars.length === 0 && <Text style={{fontSize: 20, fontWeight: "bold", marginBottom: 20,marginTop:80}}>You have not added any cars yet</Text>
        }
      <FlatList
        data={cars}
        renderItem={({ item }) => (
